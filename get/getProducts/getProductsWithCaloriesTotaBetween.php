<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET'){
        if (isset($_GET['min_calories']) && isset($_GET['max_calories'])) {
            ...
            $products = $dbProduct->getProductsWithCaloriesTotalBetween($min_calories, $max_calories);
            if ($products) {
            ...
            $response['error'] = true;
            $response['message'] = 'Missing parameter: min_calories or max_calories';
        }
    } else {
        $response['error'] = true;
