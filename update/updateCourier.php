<?php
    ...
    require_once(dirname(__FILE__) . '/../DbCourierRepository.php');
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['update_column'], $_POST['new_value'], $_POST['condition_column'], $_POST['condition_value'], $_POST['condition_type'])) {
            ...
            try {
                ...
                $result = $dbCourier->updateCourier($update_column, $new_value, $condition_column, $condition_value, $condition_type, $condition_value2);
                ...
                if ($result) {
                    ...
                    $response['error'] = true;
                    $response['message'] = 'Courier update failed';
                }
            } catch (Exception $e) {
                $response['error'] = true;
